...
[![Build Status](https://travis-ci.org/alexandru/monifu.png?branch=v0.12.1)](https://travis-ci.org/alexandru/monifu)
...
Current stable release is: `0.12.1`

### For the JVM

```scala
libraryDependencies += "org.monifu" %% "monifu" % "0.12.1"
```

### For targeting Javascript runtimes with Scala.js

```scala
libraryDependencies += "org.monifu" %% "monifu-js" % "0.12.1"
```
