...
[![Build Status](https://travis-ci.org/monifu/monifu.png?branch=v1.0-M5)](https://travis-ci.org/monifu/monifu)
...
- Current stable release is: `1.0-M5`

### For the JVM

```scala
libraryDependencies += "org.monifu" %% "monifu" % "1.0-M5"
```
