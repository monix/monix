...
abstract class Observable[+A] extends Serializable { self =>
  ...
  /** Creates a new [[monix.execution.CancelableFuture CancelableFuture]]
    ...
    */
  final def runAsyncGetFirst(implicit s: Scheduler, opts: Task.Options = Task.defaultOptions): CancelableFuture[Option[A]] =
  ...
  /** Creates a new [[monix.execution.CancelableFuture CancelableFuture]]
    ...
    * source observable. Returns an `Option` because the source can be empty.
    */
  final def runAsyncGetLast(implicit s: Scheduler, opts: Task.Options = Task.defaultOptions): CancelableFuture[Option[A]] =
