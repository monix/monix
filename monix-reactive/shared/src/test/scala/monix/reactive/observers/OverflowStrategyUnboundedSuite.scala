...
class OverflowStrategyUnboundedSuite extends BaseTestSuite {
  ...
  fixture.test("should not lose events with async subscriber, test 1") { implicit s =>
    var number = 0
    var wasCompleted = false
  ...
  fixture.test("should not lose events with async subscriber, test 2") { implicit s =>
    var number = 0
    var completed = false
