...
class OverflowStrategyDropNewSuite extends BaseTestSuite {
  fixture.test("should not lose events, synchronous test 1") { implicit s =>
    var number = 0
  ...
  fixture.test("should not lose events, synchronous test 2") { implicit s =>
    var number = 0
    var completed = false
  ...
  fixture.test("should not lose events, async test 1") { implicit s =>
    var number = 0
    var wasCompleted = false
  ...
  fixture.test("should not lose events, async test 2") { implicit s =>
    var number = 0
    var completed = false
  ...
  fixture.test("should drop incoming when over capacity") { implicit s =>
    var received = 0
    var wasCompleted = false
