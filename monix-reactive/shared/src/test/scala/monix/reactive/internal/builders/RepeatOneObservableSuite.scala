...
class RepeatOneObservableSuite extends BaseTestSuite {

  fixture.test("first execution is synchronous") { implicit s =>
    var received = 0
  ...
  fixture.test("repeatOne should be cancelable") { implicit s =>
