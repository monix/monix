...
class ConcatCancellationSuite extends monix.reactive.BaseTestSuite {
  testScheduler("issue #468 - concat is cancellable") { implicit sc =>
    var items = 0
  ...
  testScheduler("issue #468 - concatMap is cancellable") { implicit sc =>
  ...
  testScheduler("issue #468 - flatScan is cancellable") { implicit sc =>
  ...
  testScheduler("issue #468 - mapTask is cancellable") { implicit sc =>
  ...
  testScheduler("issue #468 - scanTask is cancellable") { implicit sc =>
