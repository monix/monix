...
import monix.concurrent.atomic.AtomicAny
import scala.annotation.tailrec
import monix.concurrent.Cancelable


/**
 * Represents a [[monix.concurrent.Cancelable]] that can be assigned only
 * once to another cancelable reference.
 *
 * Similar to [[monix.concurrent.cancelables.MultiAssignmentCancelable]],
