...
import monifu.Subscriber
import monifu.observers.buffers.Builders

/**
 * Interface describing [[monifu.Observer Observer]] wrappers
 ...
 *
 * See [[monifu.OverflowStrategy OverflowStrategy]] for the buffer
 * policies available.
 */
