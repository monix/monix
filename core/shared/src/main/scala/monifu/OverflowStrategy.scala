 ...
 *
 * Used in [[monifu.observers.BufferedSubscriber BufferedSubscriber]]
 * to implement buffering when concurrent actions are needed, such as in
 * [[monifu.Channel Channels]] or in [[monifu.Observable.merge Observable.merge]].
 */
...
object OverflowStrategy {
   ...
   *                   before overflowing
   */
  case class Fail(bufferSize: Int)
    extends Synchronous {
   ...
   */
  sealed trait Synchronous extends OverflowStrategy
