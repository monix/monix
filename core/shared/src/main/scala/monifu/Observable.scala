...
/** The Observable interface in the Rx pattern.
  ...
  * [[monifu.observers.BufferedSubscriber BufferedSubscriber]].
  *
  * @see [[monifu.Observer Observer]], the interface that must be
  *      implemented by consumers
  * @see [[monifu.concurrent.Scheduler Scheduler]], our enhanced `ExecutionContext`
  * @see [[monifu.Subscriber Subscriber]], the cross between an
  ...
  * @see [[monifu.Subject Subject]], which are both Observables and Observers
  * @see [[monifu.Channel Channel]], which are meant for imperatively building
  ...
  *                                error is a [[monifu.exceptions.CompositeException CompositeException]],
  ...
  *                                  downstream [[monifu.Observer Observer]] given in
  ...
  *                                  [[monifu.OverflowStrategy overflowStrategy]], see
...
trait Observable[+T] { self =>
  ...
  /** Subscribes to the stream.
    ...
    * `onError`. If it does, then the behavior is undefined.
    *
    * @param observer is an [[monifu.Observer Observer]] that respects
  ...
  /** Groups the items emitted by an Observable according to a specified
    ...
    *
    * Note: A [[monifu.observables.GroupedObservable GroupedObservable]]
  ...
  /** Groups the items emitted by an Observable according to a specified
    ...
    * one GroupedObservable per group.
    *
    * A [[monifu.observables.GroupedObservable GroupedObservable]]
    * will cache the items it is to emit until such time as it is
    * subscribed to. For this reason, in order to avoid memory leaks,
    * you should not simply ignore those GroupedObservables that do not
    * concern you. Instead, you can signal to them that they may
  ...
  /** Applies a binary operator to a start value and to elements produced
    ...
    *
    * It's the combination between [[monifu.Observable.scan scan]]
    * and [[monifu.Observable.flatten]].
    */
  ...
  /** Applies a binary operator to a start value and to elements produced
    ...
    *
    * It's the combination between [[monifu.Observable.scan scan]]
    * and [[monifu.Observable.flattenDelayError]].
    */
  ...
  /** Converts this observable into a multicast observable, useful for turning a cold observable into
    ...
    * [[monifu.subjects.PublishSubject PublishSubject]].
    */
  ...
  /** Caches the emissions from the source Observable and replays them
    ...
    * returning a [[monifu.observables.ConnectableObservable ConnectableObservable]]
    * for which you must call
    * [[monifu.observables.ConnectableObservable.connect connect]]
  ...
  /** Caches the emissions from the source Observable and replays them
    ...
    * [[monifu.observables.ConnectableObservable ConnectableObservable]]
    * for which you must call
    * [[monifu.observables.ConnectableObservable.connect connect]]
    * to activate the subscription.
    *
  ...
  /** Converts this observable into a multicast observable, useful for turning a cold observable into
    * a hot one (i.e. whose source is shared by all observers). The underlying subject used is a
    * [[monifu.subjects.BehaviorSubject BehaviorSubject]].
    */
  ...
  /** Converts this observable into a multicast observable, useful for turning a cold observable into
    * a hot one (i.e. whose source is shared by all observers). The underlying subject used is a
    * [[monifu.subjects.AsyncSubject AsyncSubject]].
    */
