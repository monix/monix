 ...
 * [[monix.OverflowStrategy.DropNew DropNew]] overflow strategy.
 */
...
private[monix] object SynchronousBufferedSubscriber {
   ...
   * for the [[monix.OverflowStrategy.DropNew DropNew]]
   * overflow strategy.
   */
  ...
  /**
   * Returns an instance of a [[SynchronousBufferedSubscriber]]
   * for the [[monix.OverflowStrategy.DropOld DropOld]]
   * overflow strategy.
   */
   ...
   * [[monix.OverflowStrategy.ClearBuffer ClearBuffer]]
   * overflow strategy.
   */
  ...
  /**
   * Returns an instance of a [[SynchronousBufferedSubscriber]]
   * for the [[monix.OverflowStrategy.ClearBuffer ClearBuffer]]
   * overflow strategy, with signaling of the number of events that
   * were dropped.
   */
