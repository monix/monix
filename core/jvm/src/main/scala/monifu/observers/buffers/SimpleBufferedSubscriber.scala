 ...
 * [[monifu.OverflowStrategy overflow strategies]]:
 *
 *   - [[monifu.OverflowStrategy.Unbounded Unbounded]]
 *   - [[monifu.OverflowStrategy.Fail Fail]]
 *
...
private[monifu] object SimpleBufferedSubscriber {
