...
package monix.concurrent.atomic.padded
...
import monix.concurrent.atomic
import monix.concurrent.atomic.{AtomicBuilder => BaseAtomicBuilder}
 ...
 * [[monix.concurrent.atomic.Atomic Atomic]] references.
 */
object Atomic {
  /**
...
/**
 * Provides a constructor for building cache-line padded
 * [[monix.concurrent.atomic.AtomicAny AtomicAny]] references.
 */
object AtomicAny {
...
/**
 * Provides a constructor for building cache-line padded
 * [[monix.concurrent.atomic.AtomicBoolean AtomicBoolean]] references.
 */
...
/**
 * Provides a constructor for building cache-line padded
 * [[monix.concurrent.atomic.AtomicByte AtomicByte]] references.
 */
object AtomicByte {
...
/**
 * Provides a constructor for building cache-line padded
 * [[monix.concurrent.atomic.AtomicChar AtomicChar]] references.
 */
object AtomicChar {
...
/**
 * Provides a constructor for building cache-line padded
 * [[monix.concurrent.atomic.AtomicDouble AtomicDouble]] references.
 */
object AtomicDouble {
...
/**
 * Provides a constructor for building cache-line padded
 * [[monix.concurrent.atomic.AtomicFloat AtomicFloat]] references.
 */
object AtomicFloat {
...
/**
 * Provides a constructor for building cache-line padded
 * [[monix.concurrent.atomic.AtomicInt AtomicInt]] references.
 */
object AtomicInt {
...
/**
 * Provides a constructor for building cache-line padded
 * [[monix.concurrent.atomic.AtomicLong AtomicLong]] references.
 */
object AtomicLong {
...
/**
 * Provides a constructor for building cache-line padded
 * [[monix.concurrent.atomic.AtomicNumberAny AtomicNumberAny]] references.
 */
...
/**
 * Provides a constructor for building cache-line padded
 * [[monix.concurrent.atomic.AtomicShort AtomicShort]] references.
 */
object AtomicShort {
