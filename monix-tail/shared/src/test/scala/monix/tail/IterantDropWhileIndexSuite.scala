...
final class IterantDropWhileIndexSuite extends BaseTestSuite {
  ...
  testScheduler("Iterant.dropWhileWithIndex equivalence with List.dropWhileWithIndex") { implicit s =>
  ...
  testScheduler("Iterant.dropWhileWithIndex protects against broken batches") { implicit s =>
  ...
  testScheduler("Iterant.dropWhileWithIndex protects against broken cursors") { implicit s =>
    check1 { (iter: Iterant[Task, Int]) =>
      val dummy = DummyException("dummy")
  ...
  testScheduler("Iterant.dropWhileWithIndex protects against user code") { implicit s =>
    check1 { (iter: Iterant[Task, Int]) =>
      val dummy = DummyException("dummy")
  ...
  testScheduler("Iterant.dropWhileWithIndex preserves the source guarantee") { implicit s =>
    var effect = 0
  ...
  testScheduler("Iterant.dropWhileWithIndex works for infinite cursors") { implicit s =>
