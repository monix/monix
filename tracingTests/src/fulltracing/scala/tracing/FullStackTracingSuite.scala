...
class FullStackTracingSuite extends BaseTestSuite {
  ...
  fixture.test("captures map frames") { implicit s =>
  ...
  fixture.test("captures bind frames") { implicit s =>
    ...
    val test =
      for (r <- traced(task)) yield {
        ...
        assertEquals(
          r.events
            .collect { case e: TaskEvent.StackTrace => e }
  ...
  fixture.test("captures async frames") { implicit s =>
  ...
  fixture.test("captures pure frames") { implicit s =>
  ...
  fixture.test("full stack tracing captures eval frames") { implicit s =>
  ...
  fixture.test("full stack tracing captures suspend frames") { implicit s =>
  ...
  fixture.test("captures raiseError frames") { implicit s =>
  ...
  fixture.test("captures bracket frames") { implicit s =>
  ...
  fixture.test("captures bracketCase frames") { implicit s =>
    val task =
