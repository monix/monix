...
package monix.iterant.cursors

import java.util
import monix.iterant.Cursor
import monix.iterant.exceptions.{CursorIsFinishedException, CursorNotStartedException}

/** [[monix.iterant.Cursor Cursor]] type that works over an underlying `Array`.
  *
