...
/** The `AsyncStream[+A]` type is a [[AsyncStream type alias]] for
  ...
  *
  * A `Task`-powered [[monix.iterant.Iterant Iterant]] is capable
  * of both lazy and asynchronous evaluation.
  *
  * @see The [[monix.iterant.Iterant Iterant]] type and
  *      [[monix.iterant.LazyStream$ LazyStream]] for synchronous/lazy
  *      evaluation.
  */
