...
/** Trait defined in order to get sharing of ScalaDoc definitions :-(
  *
  * @define NextDesc The [[monix.iterant.Iterant.Next Next]] state
  ...
  *         type used.
  *
  *         See [[monix.iterant.Iterant.NextSeq NextSeq]]
  ...
  *         $NextDesc
  *
  * @define NextSeqDesc The [[monix.iterant.Iterant.NextSeq NextSeq]] state
  ...
  *         $NextSeqDesc
  *
  * @define SuspendDesc The [[monix.iterant.Iterant.Suspend Suspend]] state
  ...
  *         $SuspendDesc
  *
  * @define LastDesc The [[monix.iterant.Iterant.Last Last]] state of the
  *         [[Iterant]] represents a completion state as an alternative to
  *         [[monix.iterant.Iterant.Halt Halt(None)]], describing one
  *         last element.
  *
  ...
  *         $LastDesc
  *
  * @define HaltDesc The [[monix.iterant.Iterant.Halt Halt]] state
  ...
  */
private[iterant] trait SharedDocs extends Any
