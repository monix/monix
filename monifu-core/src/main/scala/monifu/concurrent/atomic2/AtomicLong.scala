...
final class AtomicLong private (initialValue: Long) extends AtomicNumber[Long] {
  ...
  def incrementAndGet(): Long = incrementAndGet(1)
  def decrementAndGet(v: Int): Long = incrementAndGet(-v)
  def decrementAndGet(): Long = incrementAndGet(-1)
  def getAndIncrement(): Long = getAndIncrement(1)
  def getAndDecrement(): Long = getAndIncrement(-1)
  def getAndDecrement(v: Int): Long = getAndIncrement(-v)
