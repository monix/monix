...
abstract class Right64Java8BoxedIntImpl implements monix.execution.atomic.internals.BoxedInt {
  ...
  Right64Java8BoxedIntImpl(int initialValue) {
    UnsafeAccess.checkIfUnsafeIsAvailable();
...
final class Right64Java8BoxedInt extends Right64Java8BoxedIntImpl {
  public volatile long p1, p2, p3, p4, p5, p6 = 7;
  public long sum() { return p1 + p2 + p3 + p4 + p5 + p6; }

  Right64Java8BoxedInt(int initialValue) {
    super(initialValue);
  }
}
