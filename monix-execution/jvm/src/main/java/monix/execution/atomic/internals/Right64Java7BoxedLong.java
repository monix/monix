...
abstract class Right64Java7BoxedLongImpl implements monix.execution.atomic.internals.BoxedLong {
  ...
  static {
    ...
    try {
      Field field = Right64Java7BoxedLongImpl.class.getDeclaredField("value");
  ...
  Right64Java7BoxedLongImpl(long initialValue) {
    UnsafeAccess.checkIfUnsafeIsAvailable();
...
final class Right64Java7BoxedLong extends Right64Java7BoxedLongImpl {
  public volatile long p1, p2, p3, p4, p5, p6 = 7;
  public long sum() { return p1 + p2 + p3 + p4 + p5 + p6; }

  Right64Java7BoxedLong(long initialValue) {
    super(initialValue);
  }
}
