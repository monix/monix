...
final class NormalJava8BoxedLong implements monix.execution.atomic.internals.BoxedLong {
  ...
  static {
    ...
    try {
      Field field = NormalJava8BoxedLong.class.getDeclaredField("value");
  ...
  NormalJava8BoxedLong(long initialValue) {
    UnsafeAccess.checkIfUnsafeIsAvailable();
