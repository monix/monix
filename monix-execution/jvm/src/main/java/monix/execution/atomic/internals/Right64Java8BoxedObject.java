...
abstract class Right64Java8BoxedObjectImpl implements monix.execution.atomic.internals.BoxedObject {
  ...
  static {
    ...
    try {
      Field field = Right64Java8BoxedObjectImpl.class.getDeclaredField("value");
  ...
  Right64Java8BoxedObjectImpl(Object initialValue) {
    UnsafeAccess.checkIfUnsafeIsAvailable();
...
final class Right64Java8BoxedObject extends Right64Java8BoxedObjectImpl {
  public volatile long p1, p2, p3, p4, p5, p6 = 7;
  public long sum() { return p1 + p2 + p3 + p4 + p5 + p6; }

  Right64Java8BoxedObject(Object initialValue) {
    super(initialValue);
  }
}
