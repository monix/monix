...
final class LeftRight128Java8BoxedInt extends LeftRight128Java8BoxedIntImpl {
  ...
  LeftRight128Java8BoxedInt(int initialValue) {
    super(initialValue);
  }
}

abstract class LeftRight128Java8BoxedIntImpl extends LeftPadding56 implements BoxedInt {
  ...
  static {
    try {
      Field field = LeftRight128Java8BoxedIntImpl.class.getDeclaredField("value");
  ...
  LeftRight128Java8BoxedIntImpl(int initialValue) {
