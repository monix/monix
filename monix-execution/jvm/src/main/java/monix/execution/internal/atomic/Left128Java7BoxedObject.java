...
final class Left128Java7BoxedObject extends LeftPadding120 implements BoxedObject {
  ...
  static {
    try {
      Field field = Left128Java7BoxedObject.class.getDeclaredField("value");
  ...
  Left128Java7BoxedObject(Object initialValue) {
