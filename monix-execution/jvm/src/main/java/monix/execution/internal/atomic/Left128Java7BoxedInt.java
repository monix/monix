...
final class Left128Java7BoxedInt extends LeftPadding120 implements BoxedInt {
  ...
  static {
    try {
      Field field = Left128Java7BoxedInt.class.getDeclaredField("value");
  ...
  Left128Java7BoxedInt(int initialValue) {
