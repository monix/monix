...
final class Left64Java7BoxedObject extends LeftPadding56 implements BoxedObject {
  ...
  static {
    try {
      Field field = Left64Java7BoxedObject.class.getDeclaredField("value");
  ...
  Left64Java7BoxedObject(Object initialValue) {
