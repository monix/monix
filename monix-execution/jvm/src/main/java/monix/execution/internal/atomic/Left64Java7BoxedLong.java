...
final class Left64Java7BoxedLong extends LeftPadding56 implements BoxedLong {
  ...
  static {
    try {
      Field field = Left64Java7BoxedLong.class.getDeclaredField("value");
  ...
  Left64Java7BoxedLong(long initialValue) {
