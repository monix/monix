 ...
 * `https://github.com/typelevel/cats-effect/blob/27bb3fdffe86d299b8966eb352fa1b2fd8125395/core/jvm/src/main/scala/cats/effect/unsafe/HelperThread.scala`.
 */
...
private final class HelperThread(
  ...
  /** Called by the [[WorkerThread]] which spawned this [[HelperThread]], to
    ...
    * and die.
    */
  private[workstealing] def setSignal(): Unit = {
    signal.lazySet(true)
  }
