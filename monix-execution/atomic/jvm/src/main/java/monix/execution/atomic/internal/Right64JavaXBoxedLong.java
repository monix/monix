...
abstract class Right64JavaXBoxedLongImpl implements VarHandleBoxedLong {
  private static final VarHandle VALUE_VH;

  static {
    try {
      VALUE_VH = MethodHandles.lookup().findVarHandle(Right64JavaXBoxedLongImpl.class, "value", long.class);
