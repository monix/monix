 ...
 */
@InternalApi public interface BoxedObject {
    Object volatileGet();
    void volatileSet(Object update);
    void lazySet(Object update);
    boolean compareAndSet(Object current, Object update);
    Object getAndSet(Object update);
}
