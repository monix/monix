...
abstract class LeftRight128JavaXBoxedIntImpl extends LeftPadding56 implements VarHandleBoxedInt {
  private static final VarHandle VALUE_VH;

  static {
    try {
      VALUE_VH = MethodHandles.lookup().findVarHandle(LeftRight128JavaXBoxedIntImpl.class, "value", int.class);
