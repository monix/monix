...
abstract class Right128JavaXBoxedIntImpl implements VarHandleBoxedInt {
  private static final VarHandle VALUE_VH;

  static {
    try {
      VALUE_VH = MethodHandles.lookup().findVarHandle(Right128JavaXBoxedIntImpl.class, "value", int.class);
