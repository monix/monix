 ...
 * is built.
 */
trait ObservableGen[+T, Observable[+_]] extends Any with ObservableOperators[T, Observable] {
  type O[-I]
...
trait ObservableOperators[+T, Observable[+_]] extends Any { self: ObservableGen[T, Observable] =>
  /**
