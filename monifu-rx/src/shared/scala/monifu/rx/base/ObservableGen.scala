...
trait ObservableOperators[+T] extends Any { self: ObservableGen[T] =>
   ...
   */
  def flatten[U](implicit ev: T <:< This[U]): This[U]
   ...
   * before `onCompleted`.
   */
  def foldLeft[R](initial: R)(op: (R, T) => R): This[R]
   ...
   */
  def doOnCompleted(cb: => Unit): This[T]
   ...
   */
  def exists(p: T => Boolean): This[Boolean]
   ...
   */
  def headOrElse[B >: T](default: => B): This[B]
   ...
   */
  def firstOrElse[U >: T](default: => U): This[U]
