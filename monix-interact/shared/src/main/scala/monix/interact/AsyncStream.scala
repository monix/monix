...
/** The `AsyncStream[+A]` type is a [[AsyncStream type alias]] for
  ...
  *
  * A `Task`-powered [[monix.interact.Iterant Iterant]] is capable
  * of both lazy and asynchronous evaluation.
  *
  * @see The [[monix.interact.Iterant Iterant]] type and
  *      [[monix.interact.LazyStream$ LazyStream]] for synchronous/lazy
  *      evaluation.
  */
