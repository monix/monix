...
object CombineLatest4Suite extends BaseOperatorSuite {
  ...
  def createObservable(sc: Int) = Some {
    ...
    val o = Observable.combineLatestWith4(o1,o2,o3,o4)(_+_+_+_)
  ...
  def observableInError(sourceCount: Int, ex: Throwable) = Some {
    ...
    val o = Observable.combineLatestWith4(o1,o2,o3, flawed)(_+_+_+_)
  ...
  def brokenUserCodeObservable(sourceCount: Int, ex: Throwable) = Some {
    ...
    val o3 = Observable.now(3)
    val o4 = Observable.range(0, sourceCount)
    val o = Observable.combineLatestWith4(o1,o2,o3,o4) { (a1,a2,a3,a4) =>
  ...
  override def cancelableObservables(): Seq[Sample] = {
    val sample1 = {
      ...
      Observable.combineLatestWith4(o1,o2,o3,o4)(_+_+_+_)
    }
