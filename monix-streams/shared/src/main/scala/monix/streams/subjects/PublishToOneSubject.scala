...
import monix.streams.subjects.PublishToOneSubject.EmptySubscriber
import org.sincron.atomic.Atomic
import scala.annotation.tailrec
import scala.concurrent.{Promise, Future}

/** `PublishToOneSubject` is a [[PublishSubject]] that can be subscribed
  * at most once.
  *
  * In case the subject gets subscribed more than once, then the
  * subscribers will be notified with a [[MultipleSubscribersException]]
  * error.
  *
