...
private[monix] object take {
  /**
    * Implementation for [[Observable.take]].
    */
  ...
  /**
    * Implementation for [[monix.streams.Observable.takeRight]].
    */
  ...
  /**
    * Implementation for [[monix.streams.Observable.takeWhile]].
    */
  ...
  /**
    * Implementation for [[monix.streams.Observable.takeWhileNotCanceled]].
    */
