...
import monifu.reactive.{Observer, Channel, Subject}
 ...
 */
class SubjectChannel[-I,+O](subject: Subject[I, O], policy: BufferPolicy, s: Scheduler) extends Channel[I] with GenericObservable[O] {
